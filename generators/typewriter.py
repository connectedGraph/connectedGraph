...
def generate_typewriter(output_dir=".", theme="dark", **kwargs):
  ...
  <text x="105" y="62" class="code-text command">whoami <tspan class="flag">--brief</tspan></text>
  ...
  <text x="105" y="108" class="code-text command">show-focus</text>
  ...
  <text x="105" y="177" class="code-text command">projects <tspan class="flag">--featured</tspan></text>
