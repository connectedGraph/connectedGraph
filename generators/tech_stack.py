...
def generate_tech_stack():
    ...
    react_icon = load_icon_svg("react", react_default, "code")
    ...
    js_icon = load_icon_svg("javascript", js_default, "code")
    ...
    html5_icon = load_icon_svg("html5", html5_default, "code")
    ...
    css3_icon = load_icon_svg("css3", css3_default, "code")
    ...
    nodejs_icon = load_icon_svg("nodejs", nodejs_default, "code")
    ...
    codex_icon = load_icon_svg("codex", codex_default)
    ...
    claudecode_icon = load_icon_svg("claudecode", claudecode_default)
